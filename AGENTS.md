...
- Prefer private channels (for example Slack or the owning Session) for anything that is customer-specific, confidential, or only meaningful as internal discussion.
