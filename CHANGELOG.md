...
This release adds deployment-wide custom MCP servers, makes suggested tasks easier to launch from chat, and gives automations a private Slack delivery option alongside reliability improvements.
...
- Send custom automation reports privately to the automation owner's linked Slack account.
- Preserve chat context and task status notifications more reliably across Slack, Discord, and GitHub workflows.

### Minor changes

- Let users send custom automation reports privately to their linked Slack account with the new DM me destination.
