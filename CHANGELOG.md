...
- Show Fast response mode to every user in Personal Settings for linked Slack and Discord messages, with clearer sandbox-on-demand guidance, and keep each user's saved preference independent of deployment-level runtime enablement.
