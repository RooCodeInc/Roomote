...
- Update the bundled OpenCode CLI, SDK, and plugin seed to 1.18.32 across task and non-task inference images, including the upstream fix for high-severity OpenCode server advisory GHSA-632h-h47v-g4x4.
