...
Roomote 1.0.1 improves Session access and task navigation, brings automated Slack and Discord entries into Fast, and hardens Fast recovery, model defaults, pull-request review follow-through, and inference attribution.
...
- Open direct environment launches in their task workspace while keeping Fast retries, model defaults, pull-request auto-resolve behavior, and OpenCode Go attribution reliable.
...
- Identify OpenCode Go requests from Roomote explicitly while retaining the underlying OpenCode client and version details for accurate upstream traffic attribution.
