# Roomote Contributor License Agreement

Thank you for your interest in contributing to Roomote (the "Project"),
maintained by Roo Code, Inc. ("Roo Code", "we", "us").

This Contributor License Agreement ("Agreement") documents the rights granted
by contributors to Roo Code. This Agreement is for your protection as a
contributor as well as the protection of Roo Code and users of the Project; it
does not change your rights to use your own Contributions for any other
purpose.

By signing this Agreement (including electronically, such as by posting the
signing comment on a pull request), you accept and agree to the following
...
- **"You" (or "Your")** means the copyright owner or legal entity authorized
  by the copyright owner that is entering into this Agreement with Roo Code.
...
- **"Contribution"** means any original work of authorship, including any
  ...
  sent to the Project or its maintainers, including but not limited to pull
  requests, patches, and issue comments, but excluding communication that is
  conspicuously marked or otherwise designated in writing by You as "Not a
  Contribution."

## 2. Grant of Copyright License

Subject to the terms and conditions of this Agreement, You hereby grant to Roo
Code and to recipients of software distributed by Roo Code a perpetual,
worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright
license to reproduce, prepare derivative works of, publicly display, publicly
perform, sublicense, and distribute Your Contributions and such derivative
works, and to relicense Your Contributions and such derivative works under any
license terms, including the Project's current license and any future license
...
Project to which such Contribution was submitted. If any entity institutes
patent litigation against You or any other entity (including a cross-claim or
counterclaim in a lawsuit) alleging that Your Contribution, or the Project to
...
2. If Your employer(s) has rights to intellectual property that You create
   that includes Your Contributions, You have received permission to make
   Contributions on behalf of that employer, Your employer has waived such
   rights for Your Contributions to the Project, or Your employer has executed
   a separate corporate CLA with Roo Code.
3. Each of Your Contributions is Your original creation. Should You wish to
   ...
   source and of any license or other restriction (including, but not limited
...
4. You will notify the Project if You become aware of any facts or
   circumstances that would make these representations inaccurate in any
   respect.
...
Roo Code is under no obligation to accept or include any Contribution in the
Project.

## How to Sign

When you open a pull request, the CLA Assistant bot will check whether you
have signed this Agreement. If you have not, it will leave a comment with
instructions. To sign, post the following comment on your pull request:
