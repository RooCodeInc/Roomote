...
2. **API keys (BYOK).** Paste a key from OpenRouter, Anthropic, OpenAI, xAI,
   Google Gemini, Amazon Bedrock, Vercel AI Gateway,
    Baseten, Together AI, Moonshot AI (Kimi), Kimi Code membership, MiniMax, or OpenCode Zen / Go.
...
Gemini, Amazon Bedrock, Vercel AI Gateway, Baseten,
  Together AI, Moonshot AI (Kimi), Kimi Code membership, MiniMax, or OpenCode Zen / Go.
