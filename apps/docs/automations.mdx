...
| **Announce Roomote Updates** | Highlights after a new Roomote release is installed successfully | After a successful deployment update        |
...
version, and rollbacks do not post. When an update skips releases, the message
selects up to three authored highlights across the intervening changelog entries
and links to the full notes for the installed release. Leave its destination on
**Default** to use the standard automation destination, or choose a Slack,
Microsoft Teams, Telegram, or Discord channel or direct message. Delivery
failures remain pending for retry without reposting a destination already
