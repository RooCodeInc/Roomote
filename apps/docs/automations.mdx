...
GitHub-only by nature. The Security Auditor, Code Quality Auditor, and Resolve
PR Conflicts automations currently support GitHub only, while Suggest Ideas,
Summarize Merged PRs, and Triage Sentry Issues work with any connected
