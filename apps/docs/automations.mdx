...
not connected and no usable non-Slack destination has been resolved, reports
fall back automatically to your primary Microsoft Teams conversation, the
configured Telegram chat, or the default Discord channel. This includes a saved
Slack destination that becomes unusable after Slack is disconnected (see
