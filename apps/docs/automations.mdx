...
verified account email and passes DMARC. Roomote verifies the active provider
...
receive automation reports. If the address changes, is suppressed, the owner is
