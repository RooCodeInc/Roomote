...
and links to the full notes for the installed release. Its own Slack or Discord
destination wins, followed by the shared Manager Channel. Delivery failures
remain pending for retry without reposting a destination already recorded as
successful.
