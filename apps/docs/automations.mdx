...
| ------------------------ | -------------------------------------------------------- | ---------------------------------------------------------------------- |
| **Code Reviewer**        | Reviews pull requests automatically or on demand         | Add an extra reviewer for regressions, risky changes, and missed tests |
...
For **Code Reviewer**, decide whether Roomote should review new commits
...
- **Code Reviewer comments on too much.** Turn off draft PR review or adjust
