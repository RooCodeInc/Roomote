...
When creating an automation through Roomote chat, ask for actionable
recommendations if qualifying findings should lead to follow-up work. New
reports describe concrete follow-ups in ordinary prose and ask what you want
started, rather than posting new suggested-task cards. Reply with the work you
want Roomote to take on; after you accept, Roomote starts it through the normal
task-start flow. Work you explicitly authorized the automation to perform
autonomously continues without fresh acceptance.

Suggested-task cards posted by earlier runs remain usable. Their existing
reactions and **Start** buttons still start the selected work; see
[Start suggested tasks](/communications#start-suggested-tasks).
...
replies and previously posted suggested-task cards.
