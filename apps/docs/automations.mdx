...
Set **Automation output** first. This is the shared Manager Channel for
manager-facing posts, suggestions, summaries, and setup alerts across Slack,
Discord, Microsoft Teams, and Telegram. Make sure Roomote can access the
destination before you save it.
