...
channel when one is set, otherwise to the shared Manager Channel. If no Manager
Channel is set and Slack is not connected, reports fall back automatically to
your primary Microsoft Teams conversation, the configured Telegram chat, or
the default Discord channel (see
