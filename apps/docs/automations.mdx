...
| **Issue Fixer**              | Focused fix follow-up tasks for open GitHub issues                 | Daily or weekly                           |
...
**Issue Fixer** scans open GitHub issues across your active repositories and
launches tightly scoped implement-changes follow-up tasks for clear,
high-confidence fixes. It does not open PRs directly from the scheduled scan.
