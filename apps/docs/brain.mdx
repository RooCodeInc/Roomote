...
| `GBRAIN_RERANKER_MODEL`       | Search precision  | `openrouter:<provider>/<model-id>` | after a restart       |
...
`GBRAIN_RERANKER_MODEL` on the gbrain service to choose another model from
