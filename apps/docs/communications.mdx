...
| <IntegrationName href="/providers/communications/agentmail" icon="/logo/integrations/agentmail.svg" name="Email (AgentMail)" /> | Low-frequency task requests and results over email | Email conversations are replyable in both directions; not a sign-in provider. |
