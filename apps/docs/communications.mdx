...
| <IntegrationName href="/providers/communications/agentmail" icon="/logo/integrations/agentmail.svg" name="Email (AgentMail)" /> | Low-frequency task requests and results over email | Email is inbound-initiated only and is not a sign-in provider. |
