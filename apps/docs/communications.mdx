...
New task and automation reports describe actionable recommendations in ordinary
prose rather than posting new suggested-task cards. Roomote asks what you want
started. Reply with the work you accept, and Roomote starts it through the normal
task-start flow. Explicitly authorized autonomous work continues without fresh
acceptance.

Suggested-task cards that were already posted remain usable. Start the exact
suggestion you want by reacting to its message:
...
access to that conversation. Reactions on previously posted suggested-task cards
keep their dedicated launch behavior described above.
