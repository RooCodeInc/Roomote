...
| ----------------------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------------------- |
| <IntegrationName href="/providers/compute/roomote-cloud" icon="roomote-cloud" name="Roomote Cloud" /> | Hosted Roomote with no sandbox-vendor setup | Uses prepaid credits for managed inference and cloud-owned sandboxes. |
...
Roomote Cloud is the managed path: the hosted deployment receives one
deployment credential, while Roomote Cloud selects and pays the underlying
sandbox and inference vendors. You buy credits instead of configuring each
vendor account in Roomote.
