...
| <IntegrationName href="/providers/compute/box" icon="box" name="Box" />             | Hosted task sandboxes                                  | API-key setup, Docker projects, private previews, and same-sandbox task resume. |
