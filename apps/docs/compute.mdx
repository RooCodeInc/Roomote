...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ | --------------------------------------------------------------------------------- |
| <IntegrationName href="/providers/compute/roomote-cloud" icon="/logo/dark.svg" name="Roomote Cloud" /> | Managed Roomote Cloud deployments                      | Uses prepaid credits for Modal-backed task sandboxes; model inference stays BYOK. |
...
prepaid workspace credits. Direct Modal, E2B, Daytona, and Blaxel keep the
provider account and credentials under the operator's control.
...
- you either use Roomote Cloud credits or are comfortable managing provider
  credentials and account-level limits
