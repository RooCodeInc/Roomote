...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ | --------------------------------------------------------------------------------- |
| <IntegrationName href="/providers/compute/roomote-cloud" icon="/logo/dark.svg" name="Roomote Cloud" /> | Managed Roomote Cloud deployments                      | Roomote brokers Modal-backed task sandboxes; model inference stays BYOK.          |
...
Roomote Cloud is the lowest-setup hosted option: the managed tenant receives a
deployment-scoped credential, and Roomote Cloud brokers Modal compute against
an operator-managed service entitlement. Direct Modal, E2B, Daytona, and
Blaxel keep the provider account and credentials under the operator's control.
...
- you either use a managed Roomote Cloud deployment or are comfortable
  managing provider credentials and account-level limits
