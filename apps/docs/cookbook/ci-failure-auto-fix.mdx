...
`Webhook` · `Setup: about 10 minutes` · `Requires: admin, source control, Manager Channel` · `Serves: engineers`

**Contributor:** [Bruno](https://github.com/brunobergher)
**Contributor company:** [Roomote](https://roomote.dev)
