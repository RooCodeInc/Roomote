...
original artifact. If native delivery fails, Roomote shares a viewer link and
states that the video could not be attached. See [Slack video replies](/providers/communications/slack#video-replies).
