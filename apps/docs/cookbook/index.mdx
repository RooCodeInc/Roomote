...
| Recipe | Use to |
| --- | --- |
| [Delegate from your coding agent](/cookbook/delegate-from-your-coding-agent) | Keep your preferred coding agent in control while Roomote handles isolated, asynchronous work through MCP. |
