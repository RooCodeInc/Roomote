...
description: Turn the week's merged product work into a customer-ready Resend draft on a schedule.
icon: mail
contributor: Bruno
...
`Schedule` · `Setup: about 30 minutes` · `Requires: admin, custom Resend MCP server` · `Serves: PMs, founders, marketing`
