...
1. Connect the integrations your triage needs on the **Integrations** page.
2. Under **Settings > Skills**, add the custom skill below and enable it for the environment your product runs in.
3. Add the escalation channel under **Automations > Auto-respond to channels** and paste the launch criteria.
