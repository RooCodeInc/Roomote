...
description: A contributor-ready skeleton for documenting a reusable Roomote system.
icon: file-text
---

Use this skeleton when contributing a Cookbook recipe. Replace every placeholder
and remove the comments before opening a pull request. If the recipe comes from
another team, add a short attribution after the metadata line, such as
