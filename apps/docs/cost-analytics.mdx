...
When you can access a Session, its detail rows link back to that Session. A
private Session you cannot access stays anonymized and unlinked, including for
deployment admins.
