...
| `AZURE_SANDBOX_SIZE`                 | Optional          | Default sandbox size: `S` (0.5 vCPU/1 GiB), `M` (1 vCPU/2 GiB, default), `L` (2 vCPU/4 GiB). CPU scales up automatically for ACA's cores×2Gi tier cap.                     |
