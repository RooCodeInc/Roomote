...
| `AZURE_SANDBOX_SIZE`                 | Optional          | Default sandbox size: `XS` (0.25/0.5 GiB/5 GiB disk), `S` (0.5/1 GiB/10 GiB disk), `M` (1/2 GiB/20 GiB, default), `L` (2/4/40 GiB), `XL` (4/8/80 GiB). ACA caps memory at cores×2Gi and disk at cores×20Gi; CPU scales up automatically as needed.                     |
