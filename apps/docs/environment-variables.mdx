...
| `R_WEB_SHUTDOWN_HARD_TIMEOUT_MS` | Optional    | Total web shutdown deadline, including the Fast-turn drain and Next.js server cleanup. Defaults to `28000`, with the final 5 seconds reserved for Next.js cleanup before a forced exit. |
