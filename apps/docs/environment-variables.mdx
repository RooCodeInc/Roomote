...
| `R_VISION_MODEL`                       | Optional     | Vision model for image inspection. Audio transcription and video descriptions also use it when **Also use for audio and video** is enabled in **Settings > Models**. |
