...
| `R_DISCORD_GATEWAY_SECRET`     | Discord           | Shared internal secret for Discord event delivery between BullMQ and API. Required outside local development when Discord is enabled. Keep this distinct from `ENCRYPTION_KEY`. |
