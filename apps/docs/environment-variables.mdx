...
| Env var | Required | Used for |
| --- | --- | --- |
| `R_HTTP_INTEGRATIONS_ENABLED` | Optional | Enables shared HTTP-integration discovery and the API endpoint. Defaults to `false`. Set consistently on API, web, and background control-plane services. |
