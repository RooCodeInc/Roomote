...
| `AZURE_SANDBOX_SIZE`                 | Optional          | Default sandbox size: `XS` (0.25 vCPU/0.5 GiB), `S` (0.5/1 GiB), `M` (1/2 GiB, default), `L` (2/4 GiB/40 GiB disk), `XL` (4/8 GiB/80 GiB disk). CPU scales up automatically for ACA's cores×2Gi tier cap.                     |
