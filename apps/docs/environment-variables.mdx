...
| `R_VISION_MODEL`                       | Optional     | Media model for image inspection, audio transcription, and video description. Choose one that supports the inputs you use.              |
...
| `R_VISION_MODEL_REASONING_EFFORT`      | Optional     | Reasoning level for the media model.                                                                                                    |
