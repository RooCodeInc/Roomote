...
| `R_VISION_MODEL`                       | Optional     | Model for image inspection.                                                                                                          |
| `R_AUDIO_VIDEO_MODEL`                  | Optional     | Model for audio transcription and video descriptions. Defaults to the coding model.                                                   |
...
| `R_AUDIO_VIDEO_MODEL_REASONING_EFFORT` | Optional     | Reasoning level for the Audio and video model.                                                                                           |
