...
| `DOCKER_WORKER_DISK_LIMIT`    | Optional          | Requested writable-layer limit. Defaults to `20g`; unsupported drivers warn and continue without a per-container disk quota.    |
