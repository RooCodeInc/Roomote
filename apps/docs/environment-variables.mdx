...
| `ROOMOTE_CLOUD_URL`                  | Roomote Cloud     | Managed control-plane URL injected into a hosted tenant.                                                                                                  |
| `ROOMOTE_CLOUD_DEPLOYMENT_TOKEN`     | Roomote Cloud     | Secret deployment-scoped credential for managed sandbox and integration requests.                                                                         |
| `ROOMOTE_CLOUD_DEPLOYMENT_ID`        | Roomote Cloud     | Non-secret control-plane deployment identifier injected during provisioning.                                                                              |
| `ROOMOTE_CLOUD_INTEGRATION_SECRET`   | Roomote Cloud     | Secret used to verify integration deliveries from the control plane.                                                                                      |
