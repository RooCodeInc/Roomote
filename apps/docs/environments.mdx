...
Open **Settings > Environments > New** and choose the repository or repositories
for the environment. Add any setup guidance you already know, then select
**Start Agent** so Roomote can define a reusable workspace configuration. If
you already know the configuration you need, select **Enter YAML directly**
instead.
