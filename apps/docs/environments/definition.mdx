...
3. Choose **Docker Compose** or **Dockerfile**, select the repository, and enter
   paths relative to that repository. For Compose, you can also select profiles
   or limit startup to specific services.
