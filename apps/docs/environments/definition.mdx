...
An **All repositories** sandbox does not clone every repository up front; it
starts with a `REPOSITORIES.md` index of the active repositories and the agent
checks out only the ones the task needs. Environment and repository-scoped
