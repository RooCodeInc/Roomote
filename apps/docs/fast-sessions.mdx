...
Fast directly from chat; Teams and Telegram currently use the session view for
Fast follow-ups because their inbound webhook routes do not yet carry Fast
session identity.
