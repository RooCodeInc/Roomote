...
linked people in shared Slack workspaces, and accessible Slack channels. Roomote
passes the selected destination reference through provider-specific delivery and
access checks; a self destination always resolves from your authenticated Roomote
identity. Outside a Slack conversation, name the Slack workspace and destination.
