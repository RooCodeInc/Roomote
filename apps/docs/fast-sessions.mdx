...
The official [Bitbucket Cloud MCP](https://support.atlassian.com/atlassian-ai-gateway/docs/supported-tools/#Bitbucket-Cloud-tools)
is not enabled for this direct Fast path. Its compatibility with Roomote's
