...
Ordinary Sessions remain collaborative: any signed-in deployment user with a
Session link can view its timeline and contribute to the conversation, matching
task access. [Custom-automation](/automations) Sessions are restricted to the
automation's creator and administrators; a link or participation does not grant
another member access.

The Sessions list remains focused: administrators see every Session, while
other users see Sessions they own, participate in, or have spoken in, subject
to the custom-automation ownership restriction. Replies are attributed to the
teammate who sent them.
