...
Long transcripts open on the newest messages and load older history as you
scroll upward. Roomote keeps your place while it adds that history. If the load
fails, select **Retry loading older messages**.
