...
also supports updates and explicit merge requests for existing pull requests,
issue or PR comments, review-comment replies, and reactions using the
deployment's GitHub App.
