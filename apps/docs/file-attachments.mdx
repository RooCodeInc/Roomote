...
model supporting video input. OpenAI-compatible vision models can be used when
they advertise that capability. If video input is unavailable, use screenshots
or a transcript instead.
