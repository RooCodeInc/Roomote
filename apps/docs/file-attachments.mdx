...
turn on the **Audio/video** switch next to **Vision model** and choose a
model that supports both. When off, Roomote does not send them to a model; when
on, they use only the Vision model. Existing deployments must enable this
