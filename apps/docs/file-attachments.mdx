...
artifacts; binary or oversized artifacts should be opened through their
artifact link or downloaded instead. Access is checked against the owning task
or session before content is read.
