...
Slack, Microsoft Teams, Telegram, and your source-control provider.
...
repositories, inference provider, compute provider, and collaboration surfaces.
...
- **Choose your own compute provider** — including Docker-in-Docker on your
  own host.
