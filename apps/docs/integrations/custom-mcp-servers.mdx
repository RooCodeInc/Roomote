...
**Settings → Integrations**, or private under **Personal Settings → Personal
MCP servers**. You can also ask Roomote in a Session to connect a service's
MCP server. Remote servers become available to both Fast Sessions and sandbox
tasks. Local stdio servers need a task sandbox because Roomote launches their
