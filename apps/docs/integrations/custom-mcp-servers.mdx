...
needing reconnection: agents get a clear error pointing at Integrations, and the
...
- **Everyone in this deployment** (the default) shares it with every member.
  ...
  that authorized it. It appears under **Integrations**. The member
...
- `R_CUSTOM_MCP_DISABLED=true` disables the feature entirely: the Integrations
