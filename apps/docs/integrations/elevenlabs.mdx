...
A deployment admin connects ElevenLabs once from **Integrations**
with:
...
`R_ELEVENLABS_VOICE_ID`. The connection configured in **Integrations** takes
precedence when both sources are available.
