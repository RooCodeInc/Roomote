...
A deployment admin connects ElevenLabs once from the **Integrations** page
with:
...
`R_ELEVENLABS_VOICE_ID`. The connection configured on the **Integrations**
page takes precedence when both sources are available.
