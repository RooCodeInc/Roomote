...
Exa is off by default. A deployment operator enables it from the
**Integrations** page without entering credentials. Enabled deployments
immediately get Exa's free keyless web search, page fetching, and advanced
search. Exa's rate limits apply in this mode; Exa does not publish a fixed
quota on the MCP setup page.
