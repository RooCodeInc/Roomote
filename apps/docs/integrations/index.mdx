...
| <IntegrationName href="/integrations/neon" icon="neon" name="Neon" />                                             | Querying and managing Neon databases              | Enable first, then teammates link accounts |
| <IntegrationName href="/integrations/notion" icon="notion" name="Notion" />                                       | Reading and updating shared docs and databases    | Enable first, then teammates link accounts |
