...
| <IntegrationName href="/integrations/voice" icon="openai" name="Voice" />                               | Voice calls with Roomote on Fast Sessions         | Admin connection once                      |
...
for approved HTTPS APIs. Fast sessions and sandbox agents use the same actor
