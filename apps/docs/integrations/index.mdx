...
one makes it available to everyone. If you ask Roomote to connect a provider
just for yourself, it says so rather than connecting a shared integration
quietly, and offers the routes that can stay private instead: the provider's
own remote MCP server added under [Personal Settings](/personal-settings), or a
personal [integration key](/integration-keys).
