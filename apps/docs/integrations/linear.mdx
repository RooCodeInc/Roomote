...
<Steps>
  <Step title="Set up the OAuth app">
    On a self-hosted deployment, an administrator goes to **Integrations**,
    selects **Set up Linear**, and then selects **Create the
  ...
  <Step title="Update or remove saved credentials">
    A deployment administrator can return to **Integrations** and
