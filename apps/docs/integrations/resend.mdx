...
Roomote initially disables tools that send or reschedule email and tools that
mutate contacts. Read operations remain available, and canceling a pending
scheduled email remains enabled as a safety action.
