...
An admin connects Resend once from the **Integrations** page using OAuth. The
...
An admin can opt in to individual tools from **Integrations > Resend >
Manage tools**. Disabled tools are hidden from tasks and rejected by
