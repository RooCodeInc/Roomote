---
title: Rippling
description: Give Memory an authoritative employee directory and reporting structure from Rippling HRIS.
icon: users
---
...
2. In Roomote, open the **Integrations** page and choose **Configure
   Rippling**.
