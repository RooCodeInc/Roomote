...
`Agent (on behalf of user):`. This identifies the agent as acting for the user
and prevents Roomote from attributing the words to the human; it does not
authorize the agent to speak as or impersonate the user.
