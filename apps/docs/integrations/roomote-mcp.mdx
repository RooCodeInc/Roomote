...
Roomote MCP can also read and continue a Fast Session when you provide its
Session ID. Summaries, compute logs, and cancellation remain task-only
operations and require a task ID.
