...
Roomote MCP can fetch text or supported images from a public HTTP or HTTPS URL.
...
so Fast Sessions and coding tasks get the same behavior. The tool treats every
