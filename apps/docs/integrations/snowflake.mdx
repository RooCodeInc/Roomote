...
Admins connect Snowflake from the **Integrations** page with an account
...
2. Enter the encrypted PKCS8 private key and passphrase in **Integrations > Snowflake**. Leave both fields blank on later edits to keep the stored key.
