...
Admins connect Supermemory once from the **Integrations** page.

## What to expect

Supermemory is a shared deployment memory store for Roomote tasks and
...
In a session, ask Roomote to remember a durable preference, decision, correction, or
fact. Roomote uses Supermemory's available writing tools, and later tasks or
