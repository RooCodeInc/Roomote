...
When an admin enables Zero, Roomote installs the `zero` CLI for matching tasks
and activates the packaged Zero skill. Completing user OAuth lets agents
authenticate through the MCP connector and run the capability loop with shell
commands.
