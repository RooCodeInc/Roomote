...
Live Previews are live application URLs, not screenshots: you can navigate the
app while reviewing the task, open it in a new tab, and check desktop or mobile
layouts without pulling the branch locally.
