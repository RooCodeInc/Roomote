...
OpenCode Go, xAI Grok / SuperGrok, and Z.AI Coding Plan), the provider row also
shows current plan usage when the provider reports it, such as remaining legacy
Copilot premium-request quota, the percent used of the ChatGPT 5-hour and
weekly limits, or Grok included-usage windows.
