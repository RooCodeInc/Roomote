...
Turn on the **Audio/video** switch next to **Vision model** in **Settings > Models**
and choose a model that supports both. When enabled, audio and video use only the
Vision model; Roomote does not try the helper or coding model instead.
