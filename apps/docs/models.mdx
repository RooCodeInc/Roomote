...
Google Vertex AI, Google Gemini, xAI, ChatGPT subscriptions, and managed
Roomote Cloud inference. Roomote Cloud deployments expose stable `roomote/*`
aliases and do not require the customer to configure an upstream model key.
