...
Roomote 1.3 adds **GPT-6 Astra** to this recommended set for OpenRouter, OpenAI
API, ChatGPT Subscription, and Roomote inference. Existing model defaults do not
change; enable Astra and assign it to a role when you want to use it.
