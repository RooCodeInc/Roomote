...
Use **User Profile** to update account details such as your name, email,
...
account. Use the email shown in your profile when signing in on mobile or other
devices. After setting a password, you can update it from Personal Settings.
