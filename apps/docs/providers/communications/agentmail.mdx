...
button for each option; clicking one records your answer and the agent
continues. You can always answer by replying to the email instead.
Multi-question prompts are answered by reply, one answer per line.
