...
account email, even when it has not been verified yet. Each run uses that exact
selected identity for its initial message and threaded report. If membership is
