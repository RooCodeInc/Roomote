...
Linked senders can list callable skills by sending `/skills` as the complete
email subject or body. Use `/skills 2` to continue the list, then start a new
request with an exact token such as `$review-code`.
