...
- **Fast response mode** is enabled by default for ordinary Discord DMs,
  mentions, and eligible thread replies from your linked account; turn it off
  under **Settings > Personal** to start tasks by default instead
