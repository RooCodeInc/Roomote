...
send onboarding work to the linked setup user's direct messages. Discord
connects to Roomote through the Gateway, so it does not require an inbound
webhook or public callback URL.
