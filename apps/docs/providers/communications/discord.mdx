...
- use `/goal objective:<objective>` to make the current Fast Session pursue an
...
- paste a Discord message link (`https://discord.com/channels/.../.../...`) in
  any Fast Session so the agent can pull that message and nearby channel/thread
...
Fast Discord threads continue reaching Fast after a peer is mentioned. Roomote
