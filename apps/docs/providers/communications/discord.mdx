...
- enable **Fast response mode** under **Settings > Personal** to send ordinary
  Discord DMs, mentions, and eligible thread replies from your linked account
  through the fast orchestrator
