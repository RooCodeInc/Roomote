...
reply in such a thread is judged before it can start a turn and routes only
when it is addressed to Roomote and expects a response; otherwise Roomote may
ignore ambient discussion. Explicit bot mentions, commands, DMs, and replies to
