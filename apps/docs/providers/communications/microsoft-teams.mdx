...
[judgment model](/models#judgment-model) is configured, an eligible
unmentioned thread reply still routes only when the model finds it is
addressed to Roomote and more than a closing acknowledgement.
