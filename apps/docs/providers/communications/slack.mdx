...
Mention the app and use `/fast <question>` to get a quick answer without
starting another task. For example: `@Roomote /fast summarize this thread`.
The earlier `!fast <question>` form remains supported for compatibility.
