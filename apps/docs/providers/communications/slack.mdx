...
reply from a linked member in a Roomote thread is judged before it can start a
turn: it routes when the model finds it is addressed to Roomote and is more
