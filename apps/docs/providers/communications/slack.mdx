...
then ask Roomote to post an update to an explicit workspace and destination. Public
channels require app membership; private channels also require your linked
Slack account to be a member, and direct messages require workspace-scoped
linked identities. Reactions remain scoped to the current inbound message. Roomote
