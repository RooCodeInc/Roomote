...
then ask Roomote to post an update to an explicit workspace and destination. You
can also ask Roomote to DM your own linked Slack account or an explicitly named
linked member in a shared workspace. Public channels require app membership;
