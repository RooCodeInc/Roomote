...
thread. A self destination is always resolved from your authenticated identity;
it is not a caller-supplied user ID. Public channels require app membership;
