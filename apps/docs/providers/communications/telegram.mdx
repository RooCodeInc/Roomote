...
keeps it active across intermediate replies while more work remains. A final
reply clears it naturally. Telegram does not support native drafts in group
chats, so groups use Telegram's standard typing status instead.
