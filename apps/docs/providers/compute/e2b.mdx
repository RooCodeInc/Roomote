...
When you connect E2B from **Settings > Sandboxes**, Roomote provisions the
worker template and saves its ID. Environment-only deployments must build or
provision that worker template separately and set `E2B_TEMPLATE_ID`.
