...
Requests use the connected Copilot plan. Some models or requests may consume
premium requests according to GitHub's current multipliers and allowance;
Roomote shows the provider-reported remaining premium-request quota when GitHub
returns it. GitHub billing and [Copilot plan details](https://github.com/features/copilot/plans)
are authoritative.
...
4. run a small task and check the premium-request usage line when available
