...
Roomote accepts either the Ollama service root or a URL ending in `/v1`. The
local default is `http://127.0.0.1:11434`; in a container deployment, use a
hostname that Roomote can resolve, such as `http://ollama:11434`.
