...
Vercel AI Gateway can also serve TypeSafe's Jev (`typesafe-ai/jev`) as
Roomote's [judgment model](/models#judgment-model). Select **Jev via Vercel AI
Gateway** under **Judgment model** in **Settings > Models** to route typed
decision requests through your gateway. Your gateway must allow access to that
model.
