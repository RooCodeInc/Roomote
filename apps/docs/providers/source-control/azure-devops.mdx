...
Active members and admins can ask Roomote to read and complete a pull request in
...
Roomote completes a PR only after an explicit request in the current human message.
