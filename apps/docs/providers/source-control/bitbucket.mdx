...
repository, deployment members and admins can use sessions for bounded API operations
...
The session API does not support reopening PRs, writing files, creating
