...
description, add or edit a pull request discussion comment, or close it by **declining**
...
reports provider errors or unsupported capabilities. Thread replies are not
...
inline review threads. Existing mention replies and coding tasks are unchanged.
