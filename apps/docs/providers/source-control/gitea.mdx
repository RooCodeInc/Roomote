...
Repository sync can also create pull request webhooks, allowing Code Reviewer
...
Gitea pull request reviews use the same Code Reviewer automation targeting model
