...
After the Gitea values are available, open **Settings > Source Control** and
refresh Gitea. Roomote lists repositories from the Gitea API and stores them as
Gitea repository rows.
