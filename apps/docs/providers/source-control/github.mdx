...
linked GitHub account. Tool discovery requires the deployment's normal eligible
...
GitHub under **Settings -> Linked Accounts** first: the gist tool is offered only
