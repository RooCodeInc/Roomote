...
Fast can update an existing pull request's title or description, close or reopen
it, add a top-level issue or pull request comment, and reply to an existing PR
review comment without starting a coding task. These actions use the deployment
...
identify the repository and issue or pull request.

Merging or creating pull requests, changing branches or files, managing reviewers
or draft status, editing or deleting comments, and repository administration are
