...
The setup flow asks only for the access token and, when needed, the self-managed
GitLab base URL. OAuth and webhook verification settings remain available under
Settings for deployments that need them.
