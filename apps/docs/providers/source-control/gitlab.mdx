...
GitLab merge-request reviews use the same Code Reviewer automation targeting
model as GitHub. After syncing repositories, associate the GitLab repository
with the intended environment and enable Code Reviewer automation for that target.
