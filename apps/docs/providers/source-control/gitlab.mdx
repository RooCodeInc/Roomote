...
After the application credentials are configured, open **Settings > Source
Control**, authorize GitLab, and refresh it. Roomote lists the projects visible
to the authorized GitLab account and stores them as GitLab repository rows.
