...
- **Everyone** can browse the current and previous release notes bundled in the
  running image, with the latest release expanded. After an upgrade, Roomote
  also shows the latest "what's new" notice once.
