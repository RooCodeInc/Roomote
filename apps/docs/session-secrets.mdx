...
transcript. You enter the key once, either when an agent asks for it in a
Session or under **Settings → Personal → Integrations**; from then on it is an
...
You can also add an integration directly under **Settings → Personal →
Integrations**, naming the origin, header, methods, and key yourself. Either
...
task ends, the integration expires or is revoked, or you turn Session secret
