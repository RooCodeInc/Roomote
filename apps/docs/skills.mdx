...
The **Instance skills** section is available to every signed-in member.
...
Admins also retain the **Environment skills** section for existing custom and
marketplace skills. These remain attached to selected environments. They are
...
The skill appears in **Settings > Skills > Instance skills**. There is no
