...
Admins also see an **Environment-specific Skills** section below the shared
catalog. It lists the custom and marketplace skills available in each
environment. Admins can create, edit, or delete inline custom skills, choose
which environments use them, and search the marketplace for published skills.
