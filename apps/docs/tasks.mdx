...
CSV and TSV artifacts open as tables by default. The preview keeps the first row
as data rather than assuming it contains headings, preserves quoted fields and
line breaks, and reports malformed or truncated data. Switch to **Source** to
inspect the complete loaded text.
