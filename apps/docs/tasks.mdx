...
Use the owning Session for conversation, input, reports, and follow-up. Open the
task view as the execution-review surface when you need evidence for your normal
review process. A task is complete only when that evidence is clear enough for
a teammate to trust, continue, or reject the result.
