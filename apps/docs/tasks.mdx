...
When a task turn ends with code changes, Roomote automatically compares what
you asked for, the agent's closing report, and the diff. If a requested change
...
a second and does not replace pull request review.
