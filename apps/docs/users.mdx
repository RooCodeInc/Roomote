...
To add more than 10 users, apply a license key from the Roomote maintainers in
...
The License section shows the current seat usage, license status, and licensee.
Keys are verified offline; the deployment never contacts a license server.
