...
import { getTaskRunVisiblePrompt, getTaskRunPromptText } from '@/lib';

function buildTaskRun(payload: TaskPayload) {
  return { payload } as const;
}

describe('getTaskRunPromptText', () => {
  it('prefers description-based prompts when present', () => {
    expect(
      getTaskRunPromptText(
        buildTaskRun({
