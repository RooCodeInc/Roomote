    ...
    <AttachmentContext.Provider value={contextValue}>
      <div
        className={cn(
          ...
          variant === 'inline' && [
            'flex min-w-0 max-w-full cursor-pointer select-none items-center gap-2',
  ...
  return (
    <div
      className={cn(
        ...
        variant === 'inline' && 'size-8 rounded bg-background',
...
type AttachmentRemoveProps = ButtonAsButtonProps & {
  label?: string;
};
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        variant === 'inline' && [
          'ml-1 size-6 shrink-0 rounded p-0',
      ...
      {...props}
    >
      {children ?? <Trash className="shrink-0" />}
