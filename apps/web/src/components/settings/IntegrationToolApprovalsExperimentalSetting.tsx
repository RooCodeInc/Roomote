    ...
    <Section icon={ShieldQuestion} title="Integration tool approvals">
      <div className="flex gap-3">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          tools dialog in Settings → Integrations offers Auto, Always allow, Ask
          ...
          outright. Set up Auto mode in Settings → Integrations to handle
          routine work automatically and ask before anything risky. A task asks
