...
const TASK_MODEL_ROLE_CONFIGS: readonly TaskModelRoleConfig[] = [
  {
    ...
    icon: Code2,
    modelEnvVarName: 'ROOMOTE_MODEL',
    reasoningEnvVarName: 'ROOMOTE_MODEL_REASONING_EFFORT',
  ...
  },
  {
    ...
    icon: HandHelping,
    modelEnvVarName: 'ROOMOTE_SMALL_MODEL',
    reasoningEnvVarName: 'ROOMOTE_SMALL_MODEL_REASONING_EFFORT',
  ...
  },
  {
    ...
    icon: Eye,
    modelEnvVarName: 'ROOMOTE_VISION_MODEL',
    reasoningEnvVarName: 'ROOMOTE_VISION_MODEL_REASONING_EFFORT',
  ...
  },
  {
    ...
    icon: GitPullRequest,
    modelEnvVarName: 'ROOMOTE_CODE_REVIEW_MODEL',
    reasoningEnvVarName: 'ROOMOTE_CODE_REVIEW_MODEL_REASONING_EFFORT',
  ...
  },
  {
    ...
    icon: ScanSearch,
    modelEnvVarName: 'ROOMOTE_EXPLORE_MODEL',
    reasoningEnvVarName: 'ROOMOTE_EXPLORE_MODEL_REASONING_EFFORT',
  ...
  },
  {
    ...
    icon: ScrollText,
    modelEnvVarName: 'ROOMOTE_PLANNING_MODEL',
    reasoningEnvVarName: 'ROOMOTE_PLANNING_MODEL_REASONING_EFFORT',
