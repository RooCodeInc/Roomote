      ...
      <ChevronUp
        className={cn(
          ...
          scopeToTrigger
            ...
            : 'group-data-[state=open]:opacity-100 group-data-[state=open]:top-0',
          iconClassName,
        )}
      />
      <Icon
        className={cn(
          ...
          scopeToTrigger
            ...
            : 'group-data-[state=open]:opacity-0 group-data-[state=open]:top-4',
          iconClassName,
        )}
      />
    </span>
