  ...
  'manage_custom_automations',
  {
    ...
    inputSchema: {
      ...
      prompt: z
        ...
        .optional()
        .describe(
          'Automation instructions written in product language. When the user intends actionable or launchable follow-up tasks, instruct the automation to post qualifying actions as launchable suggested tasks alongside the report; do not mention internal tool names or parameters.',
        ),
