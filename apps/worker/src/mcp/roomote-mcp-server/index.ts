...
roomoteMcpServer.registerTool(
  'manage_source_control',
  {
    ...
    description:
      ...
      'Use "close_pull_request" to close, decline, or abandon an open PR/MR without merging it or deleting its branch. ' +
