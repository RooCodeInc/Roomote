...
- "kickoffMessage" (string or null): Short task-relevant lead phrase (roughly 4-12 words) for the user-facing start ack. Name the work only; do not include environment or model. No "Getting started" prefix, emojis, markdown, quotes, mentions, or trailing period.
