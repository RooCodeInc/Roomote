...
- "kickoffMessage" (string or null): Short task-relevant kickoff phrase (roughly 6-14 words) for the user-facing start ack. Describe the work, not the workspace or model. No "Getting started" prefix, emojis, markdown, quotes, or trailing period.
