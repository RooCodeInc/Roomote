    ...
    expect(captureEvent).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        properties: expect.objectContaining({
          ...
          directed_at_roomote: false,
          allow_silent_ambient_reply: true,
          peer_directed_turn: true,
  ...
  it('records identifier-free first-response and startup timings', () => {
    ...
    expect(captureEvent).toHaveBeenCalledWith('fast_turn_settled', {
      ...
      properties: {
        ...
        opencode_event_subscribe_ms: null,
        opencode_setup_ms: null,
      },
    });
