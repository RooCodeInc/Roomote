...
export default {
  description: "List this Session's pending credential approvals and ready secret references with their origin, header, allowed methods, and expiry, without exposing credentials. Call this before preparing a new approval and before using a reference; never ask the human to copy an opaque reference. Ready references are usable by request_with_session_secret for reads and are delivered automatically to coding tasks launched from this Session.",
  args: {},
