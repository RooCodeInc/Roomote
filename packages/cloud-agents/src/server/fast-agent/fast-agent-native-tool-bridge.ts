...
export default {
  description: "Inspect tasks delegated by this Fast conversation using the same read-only task actions available to delegated Roomote tasks. Search linked tasks, inspect status and failure details, read transcript messages, or fetch compute output where supported.",
  args: {
