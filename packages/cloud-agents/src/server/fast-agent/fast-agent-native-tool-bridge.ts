...
export default {
  ...
  args: {
    ...
    videoArtifactIds: z.array(z.string()).optional().describe("Stable IDs of uploaded videos explicitly selected for native Slack delivery. Recover IDs and viewer links with manage_tasks get_summary. Never claim a video is attached unless selected here and delivery succeeds; when unavailable or delivery fails, share its viewer link and accurately describe the fallback."),
