...
- Use Blank slate when the user explicitly requests it, or when the work can be completed in a standalone sandbox without a configured environment. Instances without connected source control or configured environments can still use Blank slate for suitable work.
