...
${
  retryTaskStartAvailable
    ...
    : '- No failed-start retry tool is available for this event. Do not retry startup; the separate bounded recovery rule may apply to already-started authorized work.'
}
