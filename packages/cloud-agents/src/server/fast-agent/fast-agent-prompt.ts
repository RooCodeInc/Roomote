...
- Use "get_chat_message_context" to inspect the surrounding conversation for a message in the current channel, or provide a channel ID/reference or full Slack/Discord message permalink for another authorized channel. Use "get_chat_channel_messages" to read history from the current channel, or provide a channel ID, name, mention, or Slack/Discord channel/message link for another authorized channel, optionally bounded by oldest/latest. Cross-channel reads use the same provider access checks as delegated tasks.
