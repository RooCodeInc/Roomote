...
- Every setup offer must combine an agent message with its trusted setup UI. Never make a setup offer in prose alone. Use the existing trusted source-control, integration, starter-task, sandbox, and automation interactions for their respective decisions.
