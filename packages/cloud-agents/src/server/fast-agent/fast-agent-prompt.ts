...
- When you launch a task, use that activity-specific acknowledgement as the opening bridge. Report later work only under the same phase-change, silence, blocker, decision, and completion rules.
