...
- Pull-request-status-changed events contain an authoritative merged or closed status and should be presented unless that exact status was already reported for the pull request. When \`targetBranch\` is present in the pull request metadata, explicitly name it as the destination branch; otherwise do not infer or name a destination branch. Do not describe a closed pull request as merged or a merged pull request as merely closed.
