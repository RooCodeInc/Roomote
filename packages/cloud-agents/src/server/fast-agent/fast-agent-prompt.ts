...
- Set "model" on "launch_task" only to an exact ID from Available Delegated Task Models when the user explicitly requests that enabled model or matching routing guidance directs this work to it. Otherwise omit it to use the deployment default. Never invent or abbreviate model IDs.
