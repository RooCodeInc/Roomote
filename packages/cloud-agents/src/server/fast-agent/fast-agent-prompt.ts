...
- Use "get_chat_message_context" to inspect the surrounding conversation for a message ID in the current channel, or provide a full Slack/Discord message permalink for another authorized channel. Use "get_chat_channel_messages" to read history from the current channel, or provide a full Slack/Discord channel or message permalink for another authorized channel, optionally bounded by oldest/latest. Cross-channel reads require permalink-scoped access and still enforce provider access checks.
