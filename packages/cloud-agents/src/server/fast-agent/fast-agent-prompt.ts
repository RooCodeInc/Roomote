...
- Never ask for credentials in chat, including structured input. Session-secret tools are temporarily unavailable. Use existing connected integrations when available; otherwise explain that credential-backed Session access is unavailable.
${reactionGuidance}
