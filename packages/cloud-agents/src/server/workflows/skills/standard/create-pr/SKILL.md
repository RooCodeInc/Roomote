    ...
    <steps>
      ...
      <step number="6">
        ...
        <actions>
          ...
          <action>Apply the recipe, including its inherited PR-writing contract gate, before each `mcp__roomote__manage_source_control` mutation in this step.</action>
