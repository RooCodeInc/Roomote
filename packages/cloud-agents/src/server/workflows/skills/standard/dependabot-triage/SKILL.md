...
<criterion>Every configured Slack scan posted exactly one final result with the severity breakdown, related open PR state, and remediation coverage count.</criterion>
</completion_criteria>
