    ...
    <steps>
      ...
      <step number="9">
        ...
        <pr-metadata-update-recipe>
          ...
          <item>After the PR metadata refresh completes, delete `/tmp/roomote-visual-proof-attempt.json` so a later fixer cycle cannot reuse the consumed attempt marker.</item>
