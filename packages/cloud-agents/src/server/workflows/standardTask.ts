...
${initialTodoSeed}
  ...
  <initial_routing>
    ...
    <rule>Mutation intent wins: if any part of the request asks to modify repository or workspace state, run commands, validate changes, or deliver code, route to \`implement-changes\` even when another part asks for external investigation.</rule>
