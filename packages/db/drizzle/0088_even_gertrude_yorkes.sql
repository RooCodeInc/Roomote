...
CREATE INDEX "session_egress_workloads_session_idx" ON "session_egress_workloads" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "session_secret_approvals_session_owner_idx" ON "session_secret_approvals" USING btree ("session_id","owner_user_id");--> statement-breakpoint
