...
export const FEATURE_FLAG_CONFIG: FeatureFlagConfigMap = {
  composerSuggestions: {
    ...
    description:
      'Show a suggested follow-up message in the task and session composers after each completed agent turn. Generated by the helper model (one small inference call per turn per conversation).',
  },
};
