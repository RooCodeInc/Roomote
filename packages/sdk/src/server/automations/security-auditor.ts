...
Only submit HIGH-confidence findings or materially missing secure-by-default corrections. If there are no actionable findings after reviewing the listed PRs, do not call submit_automation_work_items and do not post_to_slack_channel. End the task response with a terse internal note that no security follow-up was needed.
