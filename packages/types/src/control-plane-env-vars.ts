...
/**
 * Cloud browser credentials for the Fast `browse` tool. The api process
 * drives the browser; a task sandbox has its own agent-browser install and
 * never needs the control plane's provider key.
 */
