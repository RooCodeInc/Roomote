...
export const manageCustomAutomationsFieldSchemas = {
  ...
  prompt: z
    ...
    .optional()
    .describe(
      'Automation instructions written in product language. Do not include the automation cadence; keep it only in the schedule field. For actionable recommendations, instruct the automation to describe concrete follow-ups in ordinary prose and ask what the user wants started. After acceptance, start the accepted work through the normal task-start flow. Keep explicitly authorized autonomous work unchanged; it does not need fresh acceptance. Do not mention internal tool names or parameters.',
    ),
