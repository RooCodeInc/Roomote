...
export const SETUP_MODEL_PROVIDER_CATALOG = [
  ...
  },
  {
    ...
    suggestedTaskModels: mapRecommendedTaskModels({
      ...
      'claude-opus-5-5': 'cloudflare-ai-gateway/anthropic/claude-opus-5-5',
      ...
      'glm-5-3': 'cloudflare-ai-gateway/workers-ai/@cf/zai-org/glm-5.3',
    ...
    recommendedRoleModels: {
      ...
      planning: 'cloudflare-ai-gateway/anthropic/claude-opus-5-5',
    },
  ...
  },
  {
    ...
    suggestedTaskModels: mapRecommendedTaskModels({
      'glm-5-3-flash': 'cloudflare-workers-ai/@cf/zai-org/glm-5.3-flash',
      'glm-5-3': 'cloudflare-workers-ai/@cf/zai-org/glm-5.3',
